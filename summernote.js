...
/**
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      color: function (lang) {
        var colorButtonLabel = '<i class="fa fa-font" style="color:black;background-color:yellow; font-style: normal; font-weight: bold;">A</i>';
        var colorButton = tplButton(colorButtonLabel, {
          className: 'note-recent-color',
          title: lang.color.recent,
          event: 'color',
      ...
      // DS: added additional separated buttons ------------------------------->
      left: function (lang) {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      // DS last element - for IE last string bug fix
